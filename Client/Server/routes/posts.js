...
route.post("/:userId/post/:postId/comment", mult, commentController.addComment);

//Delete comment

route.delete("/:userId/post/:postId/comment/:commentId", commentController.deleteComment);
